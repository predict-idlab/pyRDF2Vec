try:
    ...
    warnings.warn(
        "mimeparse not found - I need this for content negotiation, install with 'easy_install mimeparse'"
    )
    mimeparse = None
...
MIMETYPE_FORMAT = dict(list(map(reversed, list(FORMAT_MIMETYPE.items()))))  # type: ignore
